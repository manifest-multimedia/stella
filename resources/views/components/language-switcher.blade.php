...
<div class="dropdown mr-1 ml-1" id="language">
   <button class="btn btn btn-lg dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
       <x-flag-1x1-us style="height:20px"/>  Language
   </button>
   <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
     <a class="dropdown-item" href="#"><x-flag-1x1-us style="height:20px"/> English</a>
     <a class="dropdown-item" href="#"> <x-flag-1x1-se style="height:20px"/> Swedish</a>
